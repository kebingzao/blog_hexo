...
不过上述会有一个问题，就是当整个页面从加载之后，都没有任何的用户行为的时候(比如点击，输入), 这时候执行 `audio.play()` 是会报错的，会报这个错:
```javascript
DOMException: play() failed because the user didn't interact with the document first
```
这个是因为浏览器不允许在没有静音的情况下，同时用户没有行为操作的情况下，进行视频或者音频的播放。 不过可以通过另一种方式来进行自动播放， 那就是可以在 audio/video 的 html 组件中，使用 autoplay 来进行自动播放
```javascript
<audio id="webrtcAudio" :src="getAudioUrl()" autoplay style="width:0;height:0"></audio>

getAudioUrl(){
  return URL.createObjectURL(dataURLtoBlob(`data:audio/mpeg;base64,`))
}
```
然后将上面的代码换成:
```javascript
let audio = document.getElementById('webrtcAudio')
let audioStream = audio.mozCaptureStream ? audio.mozCaptureStream() : audio.captureStream()
let audioTrack = audioStream.getAudioTracks()[0]
this.#pc.addTrack(audioTrack, audioStream)
```
只要在初始化 audio 组件的时候，就将这个声音自动播放了，那么到连接 webrtc 的时候，就不需要再播放了，直接获取 track 就行了
